...
int num_words = 30;
int qtd_word[30];
char keywords[50][100] = {"jesus", "deus", "temor", "senhor", "pastor", "não tema", "amigo", "montanha",
                          "rei", "desculpa", "dia", "pecado", "tempo", "mora", "amo", "serpente", "homem",
                          "ele", "vai", "decepcionado", "eu", "vida", "rosa", "livro", "interessante",
                          "bastismo", "mundo", "flor", "estrela", "noite", };
